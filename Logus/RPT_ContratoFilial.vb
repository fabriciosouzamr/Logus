...
Public Class RPT_ContratoFilial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_ContratoFilial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ContratoFilial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ContratoFilial = New RPT_ContratoFilial
        rpt.Site = Me.Site
        Return rpt
    End Function
