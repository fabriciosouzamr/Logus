...
Public Class RPT_ContratoAFixar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_ContratoAFixar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ContratoAFixar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ContratoAFixar = New RPT_ContratoAFixar
        rpt.Site = Me.Site
        Return rpt
    End Function
