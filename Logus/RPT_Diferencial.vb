...
Public Class RPT_Diferencial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Diferencial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AgrupaFornecedor() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Diferencial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Diferencial = New RPT_Diferencial
        rpt.Site = Me.Site
        Return rpt
    End Function
