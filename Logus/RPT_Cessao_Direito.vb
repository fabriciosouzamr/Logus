...
Public Class RPT_Cessao_Direito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Cessao_Direito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Cessao_Direito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Cessao_Direito = New RPT_Cessao_Direito
        rpt.Site = Me.Site
        Return rpt
    End Function
