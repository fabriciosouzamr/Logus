...
Public Class RPT_Contrato_Outros
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Contrato_Outros.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Contrato_Outros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Contrato_Outros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Contrato_Outros = New RPT_Contrato_Outros
        rpt.Site = Me.Site
        Return rpt
    End Function
