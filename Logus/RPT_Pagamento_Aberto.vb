...
Public Class RPT_Pagamento_Aberto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Pagamento_Aberto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Pagamento_Aberto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AgrupadoFornecedor() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Pagamento_Aberto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Pagamento_Aberto = New RPT_Pagamento_Aberto
        rpt.Site = Me.Site
        Return rpt
    End Function
