...
Public Class RPT_SEC_Usuario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Custo.NET.RPT_SEC_Usuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IC_EXIBIR_FILIALACESSO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_SEC_Usuario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_SEC_Usuario = New RPT_SEC_Usuario
        rpt.Site = Me.Site
        Return rpt
    End Function
