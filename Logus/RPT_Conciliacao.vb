...
Public Class RPT_Conciliacao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Conciliacao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Conciliacao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Conciliacao = New RPT_Conciliacao
        rpt.Site = Me.Site
        Return rpt
    End Function
