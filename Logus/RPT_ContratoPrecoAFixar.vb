...
Public Class RPT_ContratoPrecoAFixar
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_ContratoPrecoAFixar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_ContratoPrecoAFixar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property sectransp() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property secpreposto() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property secfax() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property secdtlimite() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedRPT_ContratoPrecoAFixar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ContratoPrecoAFixar = New RPT_ContratoPrecoAFixar
        rpt.Site = Me.Site
        Return rpt
    End Function
