...
Public Class RPT_NotaRemessa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_NotaRemessa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_NotaRemessa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_NotaRemessa = New RPT_NotaRemessa
        rpt.Site = Me.Site
        Return rpt
    End Function
