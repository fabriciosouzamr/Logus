...
Public Class RPT_Adiantamento_Exposure
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Adiantamento_Exposure.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Adiantamento_Exposure.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Dolar() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Adiantamento_Exposure
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Adiantamento_Exposure = New RPT_Adiantamento_Exposure
        rpt.Site = Me.Site
        Return rpt
    End Function
