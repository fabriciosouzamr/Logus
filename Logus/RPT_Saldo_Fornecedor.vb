...
Public Class RPT_Saldo_Fornecedor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Saldo_Fornecedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Saldo_Fornecedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Saldo_Fornecedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Saldo_Fornecedor = New RPT_Saldo_Fornecedor
        rpt.Site = Me.Site
        Return rpt
    End Function
