...
Public Class RPT_Amarracao_ICMS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Amarracao_ICMS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Amarracao_ICMS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Amarracao_ICMS = New RPT_Amarracao_ICMS
        rpt.Site = Me.Site
        Return rpt
    End Function
