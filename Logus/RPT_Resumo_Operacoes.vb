...
Public Class RPT_Resumo_Operacoes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Resumo_Operacoes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Resumo_Operacoes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property secgrpf() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property secgrpf1() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PagRec() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AnaSit() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Resumo_Operacoes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Resumo_Operacoes = New RPT_Resumo_Operacoes
        rpt.Site = Me.Site
        Return rpt
    End Function
