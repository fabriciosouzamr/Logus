...
Public Class RPT_Negociacao_US
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Negociacao_US.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Negociacao_US
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Negociacao_US = New RPT_Negociacao_US
        rpt.Site = Me.Site
        Return rpt
    End Function
