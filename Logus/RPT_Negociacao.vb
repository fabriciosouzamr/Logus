...
Public Class RPT_Negociacao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Negociacao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Negociacao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Negociacao = New RPT_Negociacao
        rpt.Site = Me.Site
        Return rpt
    End Function
