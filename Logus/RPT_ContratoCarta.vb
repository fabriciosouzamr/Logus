...
Public Class RPT_ContratoCarta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_ContratoCarta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ContratoCarta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ContratoCarta = New RPT_ContratoCarta
        rpt.Site = Me.Site
        Return rpt
    End Function
