...
Public Class RPT_ContratoPAF_2010
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_ContratoPAF_2010.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_ContratoPAF_2010.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ContratoPAF_2010
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ContratoPAF_2010 = New RPT_ContratoPAF_2010
        rpt.Site = Me.Site
        Return rpt
    End Function
