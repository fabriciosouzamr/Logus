...
Public Class RPT_CTR_Aditivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_CTR_Aditivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CTR_Aditivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CTR_Aditivo = New RPT_CTR_Aditivo
        rpt.Site = Me.Site
        Return rpt
    End Function
