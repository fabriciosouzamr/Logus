...
Public Class RPT_Net_Saldo_Titular
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_Net_Saldo_Titular.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Net_Saldo_Titular.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IC_ORDENACAO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_Net_Saldo_Titular
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Net_Saldo_Titular = New RPT_Net_Saldo_Titular
        rpt.Site = Me.Site
        Return rpt
    End Function
