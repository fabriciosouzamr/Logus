...
Public Class RPT_Contratos_Fixo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Contratos_Fixo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Contratos_Fixo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Contratos_Fixo = New RPT_Contratos_Fixo
        rpt.Site = Me.Site
        Return rpt
    End Function
