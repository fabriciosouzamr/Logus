...
Public Class RPT_Cacau_A_Ordem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logus.RPT_Cacau_A_Ordem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Cacau_A_Ordem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Cacau_A_Ordem = New RPT_Cacau_A_Ordem
        rpt.Site = Me.Site
        Return rpt
    End Function
