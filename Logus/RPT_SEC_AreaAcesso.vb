...
Public Class RPT_SEC_AreaAcesso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Custo.NET.RPT_SEC_AreaAcesso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_SEC_AreaAcesso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_SEC_AreaAcesso = New RPT_SEC_AreaAcesso
        rpt.Site = Me.Site
        Return rpt
    End Function
